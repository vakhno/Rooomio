...
export const Route = createFileRoute("/_public/profile")({
	...
	head: () => {
		return ({
			meta: [
				{ title: DICTIONARY[DEFAULT_LOCALE].seo.routes.profile.title },
				{ name: "description", content: DICTIONARY[DEFAULT_LOCALE].seo.routes.profile.description },
				{ name: "keywords", content: DICTIONARY[DEFAULT_LOCALE].seo.routes.profile.keywords },
				{ name: "robots", content: DICTIONARY[DEFAULT_LOCALE].seo.routes.profile.robots },
				{ name: "author", content: DICTIONARY[DEFAULT_LOCALE].seo.routes.profile.author },
				...
				{ property: "og:type", content: DICTIONARY[DEFAULT_LOCALE].seo.routes.profile.ogType },
				{ property: "og:title", content: DICTIONARY[DEFAULT_LOCALE].seo.routes.profile.ogTitle },
				{ property: "og:description", content: DICTIONARY[DEFAULT_LOCALE].seo.routes.profile.ogDescription },
				{ property: "og:site_name", content: DICTIONARY[DEFAULT_LOCALE].seo.routes.profile.ogSiteName },
				...
				{ name: "twitter:card", content: DICTIONARY[DEFAULT_LOCALE].seo.routes.profile.twitterCard },
				{ name: "twitter:title", content: DICTIONARY[DEFAULT_LOCALE].seo.routes.profile.twitterTitle },
				{ name: "twitter:description", content: DICTIONARY[DEFAULT_LOCALE].seo.routes.profile.twitterDescription },
			...
			scripts: [
				{
					...
					children: JSON.stringify(DICTIONARY[DEFAULT_LOCALE].seo.routes.profile.jsonLd)
				}
			]
