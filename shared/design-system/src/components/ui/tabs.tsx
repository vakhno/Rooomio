...
function TabsTrigger({
	...
	return (
		<TabsPrimitive.Trigger
			...
			className={cn(
				"focus-visible:ring-ring text-foreground/70 hover:bg-hover hover:text-foreground relative inline-flex min-h-8 flex-1 cursor-pointer items-center justify-center gap-1.5 rounded-[2px] border border-transparent px-3 py-1 text-sm font-extrabold whitespace-nowrap transition-[background-color,color,box-shadow,transform] group-data-[orientation=vertical]/tabs:w-full group-data-[orientation=vertical]/tabs:justify-start focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 data-[state=active]:border-border data-[state=active]:bg-selected data-[state=active]:text-foreground data-[state=active]:[box-shadow:2px_2px_0_var(--border)] [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
